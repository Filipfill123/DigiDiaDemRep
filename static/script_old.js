...
function patientIdentificationFcn() {
    ...
    if (document.querySelector('input[name="patientCategory"]:checked').value == "") {
        var params = {
...
function do_recognize() {
    ...
    switch (test_idx) {
        case -1:
            ...
            log(text_to_log); //TODO struktura stranky kvuli textu a obrazku -> SOLVED text misto countdownu, pote text none a countdown block
